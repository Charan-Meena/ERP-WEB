...
@Component({
  ...
  templateUrl: './college-admin-list.component.html',
  styleUrl: './college-admin-list.component.css'
})

export class CollegeAdminListComponent extends BaseService implements OnInit{
  pageArray:any=[];
  PageNumber:number=1;
  RowsOfPage:number=5;
  pageCount:number=0;
